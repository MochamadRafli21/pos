...
export default function Sidebar() {
  ...
  return (
    <div className='hidden md:flex flex-col justify-between pt-16 pb-16 p-2 items-center h-screen w-24 bg-white'>
    ...
    {menu.map((item, index) => {
      ...
      <div className='text-xs font-bold bg-red-400 fill-white rounded-xl border-2 border-red-400 w-16 h-16 text-white flex flex-col items-center justify-center p-2'>
