...
export default function Sidebar() {
  ...
  return (
    <div className='md:hidden z-20 bottom-0 fixed flex border-t-2 border-gray-200 justify-between p-2 items-center w-full bg-white'>
    {menu.map((item, index) => {
      return (
        ...
        <div className=
          ...
          pathname.includes(item.link)
            ? 'text-xs  fill-orange-400  w-16 h-16 text-orange-400 flex flex-col items-center justify-center p-2'
            : 'text-xs  fill-gray-400  w-16 h-16 text-gray-400 flex flex-col items-center justify-center p-2'
        }`}
        >
        {item.svg}
        <p>{item.text}</p>
